...
namespace SSkinChanger
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings MinimapAwareness = new SAssemblies.Menu.MenuItemSettings();

        public MainMenu()
        {
            MenuEntries = new Dictionary<SAssemblies.Menu.MenuItemSettings, Func<dynamic>>
                              {
                                  { MinimapAwareness, () => new MinimapAwareness() },
                              };
        }
    ...
    internal class Program
    {
        ...
        private void CreateMenu()
        {
            try
            {
                ...
                mainMenu.UpdateDirEntry(ref MainMenu.MinimapAwareness, MinimapAwareness.SetupMenu(MainMenu.Tracker.Menu));
        ...
        {
            CreateMenu();
            Common.ShowNotification("SMinimapAwareness loaded!", Color.LawnGreen, 5000);
        }
    }
}
