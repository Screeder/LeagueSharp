...
namespace SParticleLooper
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings SurrenderVote = new SAssemblies.Menu.MenuItemSettings();
    ...
    internal class Program
    {
        ...
        private void CreateMenu()
        {
            try
            {
                ...
                mainMenu.UpdateDirEntry(ref MainMenu.SurrenderVote, SurrenderVote.SetupMenu(MainMenu.Misc.Menu));
        ...
        {
            CreateMenu();
            Common.ShowNotification("SSurrenderVote loaded!", Color.LawnGreen, 5000);
        }
    }
}
