...
namespace SLanePower
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings LanePower = new SAssemblies.Menu.MenuItemSettings();

        public MainMenu()
        {
            MenuEntries = new Dictionary<SAssemblies.Menu.MenuItemSettings, Func<dynamic>>
                              {
                                  { LanePower, () => new LanePower() },
                              };
        }
    ...
    internal class Program
    {
        ...
        private void CreateMenu()
        {
            try
            {
                ...
                mainMenu.UpdateDirEntry(ref MainMenu.LanePower, LanePower.SetupMenu(MainMenu.Misc.Menu));
        ...
        {
            CreateMenu();
            Common.ShowNotification("SLanePower loaded!", Color.LawnGreen, 5000);
        }
    }
}
