...
namespace SLanePower
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings MaxRanger = new SAssemblies.Menu.MenuItemSettings();

        public MainMenu()
        {
            MenuEntries = new Dictionary<SAssemblies.Menu.MenuItemSettings, Func<dynamic>>
                              {
                                  { MaxRanger, () => new MaxRanger() },
                              };
        }
    ...
    internal class Program
    {
        ...
        private void CreateMenu()
        {
            try
            {
                ...
                mainMenu.UpdateDirEntry(ref MainMenu.MaxRanger, MaxRanger.SetupMenu(MainMenu.Misc.Menu));
        ...
        {
            CreateMenu();
            Common.ShowNotification("SMaxRanger loaded!", Color.LawnGreen, 5000);
        }
    }
}
