...
namespace SAntiNexusTurret
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings AntiNexusTurret = new SAssemblies.Menu.MenuItemSettings();
    ...
    internal class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SAntiNexusTurret loaded!", Color.LawnGreen, 5000);
        }
    }
}
