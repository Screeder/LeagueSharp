...
namespace SParticleLooper
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings SmartPingImprovement = new SAssemblies.Menu.MenuItemSettings();

        public MainMenu()
        {
            MenuEntries = new Dictionary<SAssemblies.Menu.MenuItemSettings, Func<dynamic>>
                              {
                                  { SmartPingImprovement, () => new SmartPingImprovement() },
                              };
        }
    ...
    internal class Program
    {
        ...
        private void CreateMenu()
        {
            try
            {
                ...
                mainMenu.UpdateDirEntry(ref MainMenu.SmartPingImprovement, SmartPingImprovement.SetupMenu(MainMenu.Misc.Menu));
        ...
        {
            CreateMenu();
            Common.ShowNotification("SSmartPingImprovement loaded!", Color.LawnGreen, 5000);
        }
    }
}
