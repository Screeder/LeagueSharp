...
namespace SParticleLooper
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings ParticleLooper = new SAssemblies.Menu.MenuItemSettings();

        public MainMenu()
        {
            MenuEntries = new Dictionary<SAssemblies.Menu.MenuItemSettings, Func<dynamic>>
                              {
                                  { ParticleLooper, () => new ParticleLooper() },
                              };
        }
    ...
    internal class Program
    {
        ...
        private void CreateMenu()
        {
            try
            {
                ...
                mainMenu.UpdateDirEntry(ref MainMenu.ParticleLooper, ParticleLooper.SetupMenu(MainMenu.Misc.Menu));
        ...
        {
            CreateMenu();
            Common.ShowNotification("SParticleLooper loaded!", Color.LawnGreen, 5000);
        }
    }
}
