...
namespace SHealthRelic
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings HealthRelic = new SAssemblies.Menu.MenuItemSettings();

        public MainMenu()
        {
            MenuEntries = new Dictionary<SAssemblies.Menu.MenuItemSettings, Func<dynamic>>
                              {
                                  { HealthRelic, () => new HealthRelic() },
                              };
        }
    ...
    internal class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SHealthRelic loaded!", Color.LawnGreen, 5000);
        }
    }
}
