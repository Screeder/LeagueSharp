...
namespace SHealthRelic
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings Ascension = new SAssemblies.Menu.MenuItemSettings();
    ...
    internal class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SAscension loaded!", Color.LawnGreen, 5000);
        }
    }
}
